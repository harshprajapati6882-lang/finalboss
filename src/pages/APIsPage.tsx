...
export function APIManager({
  ...
  const saveEdit = async (id: string) => {
    ...
    try {
      if (onUpdateApi) {
        ...
        console.warn('onUpdateApi not implemented');
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      if (onDeleteApi) {
        ...
        console.warn('onDeleteApi not implemented');
        alert('Delete functionality not yet connected to backend');
      }
    } catch (error) {
  ...
  // Check if edit/delete features are available
  const editDeleteEnabled = !!onUpdateApi && !!onDeleteApi;
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        disabled={isLoading[api.id] || !editValues.name || !editValues.url || !editValues.key}
                      ...
                      <button
                        ...
                        className="rounded-lg border border-slate-700 bg-transparent px-4 py-2 text-sm text-slate-300 transition hover:bg-slate-800 hover:text-white disabled:opacity-50"
                      >
                        Cancel
                      </button>
                    </div>
                      ...
                      <div className="mt-4 rounded-lg border border-red-500/30 bg-red-500/10 p-4">
                        ...
                        <div className="flex gap-2">
                          ...
                          <button
                            ...
                            disabled={isLoading[api.id]}
                            className="rounded-lg border border-slate-700 bg-transparent px-3 py-1.5 text-sm text-slate-300 transition hover:bg-slate-800 hover:text-white disabled:opacity-50"
                          >
                            Cancel
                          </button>
                        </div>
